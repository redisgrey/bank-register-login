...
import { verifyTransCode, reset } from "../features/auth/authSlice";

import Spinner from "../components/Spinner";

function VerifyTransCode() {
    ...
    const onSubmit = (e) => {
        ...
        dispatch(verifyTransCode(userData));
    };
    ...
    return (
        <>
            <section className="heading">
                <h1>
                    <FaUser /> Verify Transfer OTP Code
                </h1>
            </section>
...
export default VerifyTransCode;
